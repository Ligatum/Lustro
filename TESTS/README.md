...
Please note that BigCrush, PractRand, NIST and SMHasher are performed using dedicated test wrappers designed specifically to stress the raw Lustro Core state. These wrappers are not production implementations and exist solely to evaluate the statistical behavior of the underlying Lustro Core.<br>
